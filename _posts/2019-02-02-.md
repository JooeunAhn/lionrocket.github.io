...
<p align='center'>
<img src="{{ '/assets/img/before_a.png' | prepend: site.baseurl }}" alt="">
<audio controls controlsList="nodownload">
  <source src="{{'/assets/wav/before_a.wav'}}" type="audio/wav"> 
</audio> <br>
</p>
...
<p align='center'>
<img src="{{ '/assets/img/before_b.png' | prepend: site.baseurl }}" alt="">
<audio controls controlsList="nodownload">
  <source src="{{'/assets/wav/before_b.wav'}}" type="audio/wav"> 
</audio>
</p>
<small>3.즐거움</small>

<p align='center'>
<img src="{{ '/assets/img/before_c.png' | prepend: site.baseurl }}" alt="">
<audio controls controlsList="nodownload">
...
<p align='center'>
<img src="{{ '/assets/img/after_a.png' | prepend: site.baseurl }}" alt="">
<audio controls controlsList="nodownload">
  <source src="{{'/assets/wav/after_a.wav'}}" type="audio/wav"> 
</audio>
</p>
...
<p align='center'>
<img src="{{ '/assets/img/after_b.png' | prepend: site.baseurl }}" alt=""><br>
<audio controls controlsList="nodownload">
  <source src="{{'/assets/wav/after_b.wav'}}" type="audio/wav"> 
</audio>
</p>
...
<p align='center'>
<img src="{{ '/assets/img/after_c.png' | prepend: site.baseurl }}" alt="">
<audio controls controlsList="nodownload">
